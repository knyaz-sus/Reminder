...
import { SidebarMenuButton } from "@/modules/sidebar/sidebar";
...
export function SidebarProject({
  ...
  const deleteMutation = useDeleteOptimistic<Project>({
    mutationFn: () =>
      projectApi.deleteProject(id, adminId, session?.access_token),
    queryKey: ["user-projects", { session }],
    id,
  });
  const updateMutation = useUpdateOptimistic<Project>({
    mutationFn: () =>
      projectApi.updateProject(session?.access_token, { id, name: updateName }),
    queryKey: ["user-projects", { session }],
    id,
